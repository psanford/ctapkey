...
// from https://fidoalliance.org/specs/fido-v2.0-id-20180227/fido-client-to-authenticator-protocol-v2.0-id-20180227.html#error-responses
const (
	...
	CTAP2_ERR_NOT_BUSY              = 0x29 //	Authenticator cannot cancel as it is not busy.
